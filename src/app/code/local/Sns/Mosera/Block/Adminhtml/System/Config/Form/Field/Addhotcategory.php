...
class Sns_Mosera_Block_Adminhtml_System_Config_Form_Field_Addhotcategory extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    public function __construct()
    {
        ...
        $this->addColumn('image', array(
            'label' => Mage::helper('adminhtml')->__('Thumb'),
            'type' => 'image',
        ));	
