 ...
 */
class Sns_Mosera_Block_Navigation extends Mage_Catalog_Block_Navigation {
    ...
    protected function _construct()
    {
		...
		$this->addData(array(
			...
			'cache_tags'        => array(Mage_Catalog_Model_Product::CACHE_TAG . 'SNS_MOSERA_BLOCK_NAVIGATION'),
		));
    }
