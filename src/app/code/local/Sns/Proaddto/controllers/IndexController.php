		...
		if($params['isAjax'] == 1){
			...
			try {
				...
				if (!$cart->getQuote()->getHasError()){
                    ...
                    $co_link = "jQuery('#proaddto_confirmbox').fadeOut(200); location.href='".Mage::getUrl('checkout/cart')."'";
					$message = '<p>'.$this->__("You've just added this product to the cart: ")
                                ...
                                '<div class="sns-btnproaddto-wrap">
                                    <button type="button" name="finish_and_checkout" onclick="'.$co_link.'" id="finish_and_checkout" class="button btn-confirm-addtocart">
